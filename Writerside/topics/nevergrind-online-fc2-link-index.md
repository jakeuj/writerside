...
## 完成矩陣：一般與系統頁 {#fc2-matrix-general-system}
...
## 完成矩陣：Unique 武器 {#fc2-matrix-unique-weapons}
...
## 完成矩陣：Unique 防具與飾品 {#fc2-matrix-unique-armor-accessories}
...
## 完成矩陣：Set Normal {#fc2-matrix-set-normal}
...
## 完成矩陣：Set Exceptional {#fc2-matrix-set-exceptional}
...
## 完成矩陣：Set Elite {#fc2-matrix-set-elite}
