...
- 來源查核：[公開來源判讀與疑難排解](nevergrind-online-public-source-notes.md)、[FC2 攻略 DB 連結索引](nevergrind-online-fc2-link-index.md)
...
如果只是想知道 FC2 站內每個頁面該查什麼，先看 [FC2 攻略 DB 連結索引](nevergrind-online-fc2-link-index.md)。那篇把首頁、側欄、職業頁、物品頁、Unique 部位頁與 Set 明細頁拆成 106 個入口，這篇則只保留成長路線的讀法。
...
如果要看職業定位、裝甲階級與可用武器，回到 [職業系統總覽](nevergrind-online-classes.md)。若你正在玩牧師，可以接著看 [牧師（Cleric）](nevergrind-online-cleric.md) 與 [牧師（Scion）輸出](nevergrind-online-cleric-scion-dps.md)。

## 刷圖與刷寶路線 {#farming-route-principles}
...
2. 每次回城先到 [藥劑店（Apothecary）](nevergrind-online-apothecary.md) 做 `Identify All`，再出售低價值裝備。
...
5. 金幣壓力小、技能與背包都穩後，再把 [賭博（Gambling）](nevergrind-online-gambling.md) 當成後期 gold sink。
...
- [FC2 攻略 DB 連結索引](nevergrind-online-fc2-link-index.md)
- [公開來源判讀與疑難排解](nevergrind-online-public-source-notes.md)
