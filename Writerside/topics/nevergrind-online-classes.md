...
- 檢視日期：`2026-05-03`
- 本文整理來源：官方 Steam 頁、Nevergrind Wiki 與 Fandom 職業頁
...
| `Academy` 學院 | 城鎮 `Academy` 負責學習、升級技能或處理天賦方向 | 金幣先投入常用技能與核心循環，再追次要技能 |
...
| 十字軍 (Crusader) / 聖騎士 (Paladin) | 無敵、暈眩、自我治療與 undead 特攻 | 混合坦與神聖工具，適合處理危險窗口 |
...
下表整理來源資料中的防具、武器與特殊規則。括號中保留資料表常見英文武器熟練類型（proficiency），方便和 [Legendary Items 清單](nevergrind-online-legendary-items.md) 一起查。
