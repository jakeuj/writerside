...
1. **建議** 使用 [Rider](https://www.jetbrains.com/rider/) 開發專案，Rider 預設會將檔案編碼設定為 UTF-8。
...
[Roslyn 專案的 .editorconfig 檔案 for Visual Studio 2022](https://raw.githubusercontent.com/dotnet/roslyn/refs/heads/main/.editorconfig)
...
## 參照
- [使用 Visual Studio 2022 可透過 .editorconfig 鎖定文字檔案的儲存編碼格式](https://blog.miniasp.com/post/2024/06/07/Visual-Studio-2022-EditorConfig-UTF-8)