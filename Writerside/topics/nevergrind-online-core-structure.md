...
如果使用 `Cleric`，來源摘要常把 undead / demon 目標視為發揮輸出優勢的方向。進入 Hell 難度後，可以優先評估 `Riven Grotto`、[Fahlnir Citadel](nevergrind-online-fahlnir-citadel.md) 等不死生物或惡魔較多的區域，但仍要以角色抗性、生存、裝備與目前版本怪物配置為準。
